...
<section class="card" aria-labelledby="fresh-readings"><span class="tag">dated readings</span><h2 id="fresh-readings">Fresh readings</h2><p>Open a dated source check before acting. These are the newest fact-bound project readings, not live-status promises.</p><p><a href="/site/projects/bounty-scout.html">Bounty Scout · 12 Sep 2026 04:46 UTC</a> — 0 qualified payers in its seven-organisation public screen.</p><p><a href="/site/projects/cosmetics-change-impact.html">Cosmetics Change Impact · 11 Sep 2026</a> — five publisher responses changed in a source-watch comparison.</p><p><a href="/site/projects/cra-srp-readiness.html">CRA SRP Readiness · 11 Sep 2026</a> — source-linked reporting-clock corpus re-checked.</p></section>
