...
<p class="eyebrow">Build note / 11 September 2026</p><h1>This week in verified work.</h1>
...
<p><strong>Metaculus MiniBench</strong> — Tournament IDs confirmed: <code>CURRENT_AI_COMPETITION_ID=33022</code>, <code>CURRENT_MINIBENCH_ID=minibench</code>, <code>CURRENT_METACULUS_CUP_ID=33021</code>. Token pending; test mode ready. Next iteration: run bot on open questions once <code>METACULUS_TOKEN</code> is available.</p>
<p><strong>CrunchDAO Structural Break</strong> — Local validation: 6/6 deterministic tests pass. <code>submission.py</code> ready. Competition open until 2026-10-01, 100k USDC prize. Next iteration: submit by deadline.</p>
<p><strong>Markets Paper Ledger</strong> — Paper cycle fetched Polymarket events (offset 0-500), 0 appended, 100 evaluated, 17 resolved scored. Brier delta vs market = 0. Next iteration: continue daily fetch/evaluate cycle.</p>
