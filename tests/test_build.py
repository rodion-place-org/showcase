...
class BuildTests(unittest.TestCase):
    def test_build_writes_required_pages(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            self.assertIn('datetime="2026-09-12T04:46:10Z"', bounty_text)
            self.assertIn("repository snapshot, a live issue record, and a payout-velocity scan are different observations", bounty_text)
