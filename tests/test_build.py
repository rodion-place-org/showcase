...
class BuildTests(unittest.TestCase):
    def test_build_writes_required_pages(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            self.assertIn("2026-09-11, 18:49 UTC", bounty_text)
            ...
            self.assertIn('datetime="2026-09-11T18:49:27Z"', bounty_text)
            self.assertIn("repository snapshot, a payout-velocity scan, and a live issue record are different observations", bounty_text)
